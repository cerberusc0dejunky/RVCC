...
import truckLoadImg from '../assets/img/Truck_Load.jpeg';
import trailerLoadImg from '../assets/img/Trailer_Load.jpeg';
          ...
          (() => {
            ...
            return (
              <div className="space-y-5">
                {/* PROMINENT CALL TO ACTION DIRECTLY ABOVE THE ESTIMATOR */}
                <div className="bg-gradient-to-r from-[#1a1a1a] via-[#242424] to-[#1a1a1a] p-4 sm:p-4.5 rounded-lg border-2 border-[#1a1a1a] shadow-[4px_4px_0px_0px_#ff6600] flex flex-col sm:flex-row items-center justify-between gap-4 text-white">
                  <div className="flex items-center space-x-3.5 text-left w-full sm:w-auto">
                    <div className="w-11 h-11 rounded-lg bg-[#ff6600]/20 border border-[#ff6600] text-[#ff6600] flex items-center justify-center shrink-0 shadow-inner">
                      <Sparkles className="w-5 h-5" />
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="bg-[#ff6600] text-[#1a1a1a] text-[9px] font-mono font-black uppercase px-1.5 py-0.5 rounded-xs tracking-wider">
                          Before &amp; After Showcase
                        </span>
                        <span className="text-[10px] text-slate-300 font-mono font-bold hidden sm:inline-block">
                          Real Cleanouts &amp; Heavy Rig
                        </span>
                      </div>
                      <p className="text-sm sm:text-base font-black uppercase text-white tracking-tight font-display mt-0.5">
                        Storage Units • Garages • Heavy Hauling
                      </p>
                      <p className="text-[11px] text-slate-300 font-medium">
                        See how we haul away debris, sweep clean, and restore your space in hours.
                      </p>
                    </div>
                  </div>
                  ...
                  <button
                    type="button"
                    onClick={() => setShowWhatWeDoModal(true)}
                    className="w-full sm:w-auto shrink-0 bg-[#ff6600] hover:bg-[#e65c00] text-[#1a1a1a] hover:text-black font-black uppercase text-xs sm:text-sm px-6 py-3 rounded border-2 border-white shadow-[2px_2px_0px_0px_#ffffff] flex items-center justify-center space-x-2 cursor-pointer transition-all active:translate-x-0.5 active:translate-y-0.5 font-display tracking-wider group"
                  >
                    <span>What do we do?</span>
