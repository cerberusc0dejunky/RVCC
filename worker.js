...
Return ONLY a valid JSON object matching the requested schema with all required fields.`;
      ...
      parsedAnalysis.safetyFlags = sim.safetyFlags;
      parsedAnalysis.prohibitedItemsDetected = [
        ...new Set([...(sim.prohibitedItemsDetected || []), ...(parsedAnalysis.prohibitedItemsDetected || [])])
      ];
      parsedAnalysis.hasProhibitedItems = parsedAnalysis.prohibitedItemsDetected.length > 0;
